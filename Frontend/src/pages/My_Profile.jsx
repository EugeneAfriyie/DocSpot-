...
const My_Profile = () => {
  ...
  const [userData, setUserdata] = React.useState({
    ...
    email: "groupright00@gmail.com",
    phone: "+233 24 123 4567",
    address: {
      line1: "547003 Willans Station",
      line2: "Offinso Ghana"
    },
    gender:"Male",
    DOB: "01/01/1990",
    ...
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
      ...
      <div className="">
        ...
        <div className=" grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700 ">
          ...
          isEdit
           ? 
          <select className='max-w-20 bg-gray-100' name="gender" id="gender" onChange={e => setUserdata(prev => ({...prev,gender: e.target.value}))} value={userData.gender}>
